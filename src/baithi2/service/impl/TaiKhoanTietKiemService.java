...
import baithi2.utils.DocGhiFileTaiKhoanTietKiem;
...
public class TaiKhoanTietKiemService implements ITaiKhoanNganHangService {
    ...
    private static final String PATH = "D:\\Codegym\\Mudule2\\A0322I1-PhanDuyMan-Module-2\\src\\baithi2\\data\\TaiKhoanTietKiem.csv";
    @Override
    public void them() {
        List<TaiKhoanTietKiem> taiKhoanTietKiemList = DocGhiFileTaiKhoanTietKiem.docFileTietKiem(PATH);
        TaiKhoanTietKiem taiKhoanTietKiem = nhapThongTin();
        taiKhoanTietKiemList.add(taiKhoanTietKiem);
        DocGhiFileTaiKhoanTietKiem.ghiFileTietKiem(PATH, taiKhoanTietKiemList);
